...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Mostrar _MENU_ entradas",sZeroRecords:"No matching records found",sEmptyTable:"No hay registros disponibles en esta tabla",sInfo:"mostrando _START_ to _END_ of _TOTAL_ entradas",sInfoEmpty:"mostrando 0 to 0 of 0 entradas",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primera",sPrevious:"Anterior",sNext:"Proxima",sLast:"Ultima"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
